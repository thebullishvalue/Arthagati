...
clean, structured terminal view of the analysis pipeline.

Adapted verbatim from Nishkarsh so both products share the same
operator-console fidelity (timestamps, section banners, success/warning
checkpoints, phase timing, summary boxes).
"""
...
# ── ANSI color support ──────────────────────────────────────────────────────
# Best-effort terminal setup. Any failure here MUST NOT prevent the module
# from finishing — `console` at the bottom is the contractual public API.
